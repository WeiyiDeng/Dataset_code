...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands2588_cat3/rework_csv/434_cat3.csv", 
                    header=TRUE, sep=",")
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands2588_cat3/export_list.csv", header=FALSE, sep=",")
# trydata
...
for (i in 1:2588) {
  if (i %in% except_list){
    ...
    print(i)
    path = paste("E:/Trans/Transfer from old Toshiba/FileProcess/bands2588_cat3/", i, "_cat3.csv", sep = "")
...
write.csv(file="gtrends_cat3.csv", x=gtrends_mat)
...
write.csv(file="gtrends_cat3_423.csv", x=gtrends_mod)

sum(gtrends_mod[,3]<0)                                     # many interpolated values smaller than 0

# import merged listens and trends
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/SQLite/listens_vs_trends423.csv", header=TRUE, sep=",")
