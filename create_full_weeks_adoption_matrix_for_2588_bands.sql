...
*/
create table full_weeks_adopt_2588(BAND_ID integer, WEEK_ID integer, adopt integer);
insert into full_weeks_adopt_2588(BAND_ID, WEEK_ID, adopt)

select band_names_prep, weeks_prep, adopt
from full_weeks_mat
left join totallistens
on BAND_ID = band_names_prep and WEEK_ID = weeks_prep;

update full_weeks_adopt_2588 set adopt = 0 where adopt is null;