...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/SQLite/adopt_original_trends_left_join_full_weeks_4061.csv", header=TRUE, sep=",")
...
print(empty_bands_count)                    # w: almost 1/3 of bands are empty bands by the criteria set above !  (sum(band_rows[,1])/j>0.1)
...
write.csv(file="predict_trend4061_original.csv", x=predict_trend, row.names = FALSE)
write.csv(file="predict_trend_log4061_original.csv", x=predict_trend_log, row.names = FALSE)
