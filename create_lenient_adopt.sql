...
create table bandadoptions_lenient_adopt(USER_ID integer, BAND_ID integer, WEEK_ID integer, WEEK_USER integer, WEEK_BAND integer);
insert into bandadoptions_lenient_adopt(USER_ID, BAND_ID, WEEK_ID, WEEK_USER, WEEK_BAND)
