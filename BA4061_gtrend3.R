...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_ori/434_ori.csv", 
                    header=TRUE, sep=",")
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_ori/export_list.csv", header=FALSE, sep=",")
# trydata
...
for (i in 1:4061) {
  if (i %in% except_list){
    ...
    print(i)
    path = paste("E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_ori/", i, "_ori.csv", sep = "")
...
write.csv(file="gtrends4061_ori.csv", x=gtrends_mat)
...
write.csv(file="gtrends4061_ori_423.csv", x=gtrends_mod)
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/SQLite/listens_vs_trends423_ori.csv", header=TRUE, sep=",")
