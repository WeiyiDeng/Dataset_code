...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat35/434_cat35.csv", 
                    header=TRUE, sep=",")
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat35/export_list.csv", header=FALSE, sep=",")
# trydata
...
for (i in 1:4061) {
  if (i %in% except_list){
    ...
    print(i)
    path = paste("E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat35/", i, "_cat35.csv", sep = "")
...
write.csv(file="gtrends4061_cat35.csv", x=gtrends_mat)
...
write.csv(file="gtrends4061_cat35_423.csv", x=gtrends_mod)
