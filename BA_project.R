...
write.csv(file="newbandlist2588.csv", x=small_bandlist[,2])
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/TransferSpot/bands2588_cat3/5_cat3.csv", header=TRUE, sep=",")
class(trydata)
