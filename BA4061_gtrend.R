...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat3/434_cat3.csv", 
                    header=TRUE, sep=",")
...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat3/export_list.csv", header=FALSE, sep=",")
# trydata
...
for (i in 1:4061) {
  if (i %in% except_list){
    ...
    print(i)
    path = paste("E:/Trans/Transfer from old Toshiba/FileProcess/bands4061_cat3/", i, "_cat3.csv", sep = "")
...
write.csv(file="gtrends4061_cat3.csv", x=gtrends_mat)
...
write.csv(file="gtrends4061_cat3_423.csv", x=gtrends_mod)
