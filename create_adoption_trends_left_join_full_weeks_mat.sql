...
create table adopt_trends_left_join_full_weeks(adopt integer, trend_ori numeric, trend_cat3 numeric, trend_cat35 numeric, trend_lab numeric, bands_num_vec integer, weeks_vec integer);
insert into adopt_trends_left_join_full_weeks(adopt, trend_ori, trend_cat3, trend_cat35, trend_lab, bands_num_vec, weeks_vec)

--SELECT count(*)
--FROM(
select adopt, gtrends_ori.gtrends as trend_ori, gtrends_cat3_mod.gtrends as trend_cat3, gtrends_cat35.gtrends as trend_cat35, gtrends_lab.gtrends as trend_lab, full_weeks_adopt_2588.BAND_ID, full_weeks_adopt_2588.WEEK_ID
from full_weeks_adopt_2588
left join gtrends_ori 
on full_weeks_adopt_2588.BAND_ID = gtrends_ori.bands_num_vec and full_weeks_adopt_2588.WEEK_ID = gtrends_ori.weeks_vec
left join gtrends_cat3_mod 
on full_weeks_adopt_2588.BAND_ID = gtrends_cat3_mod.bands_num_vec and full_weeks_adopt_2588.WEEK_ID = gtrends_cat3_mod.weeks_vec
left join gtrends_cat35 
on full_weeks_adopt_2588.BAND_ID = gtrends_cat35.bands_num_vec and full_weeks_adopt_2588.WEEK_ID = gtrends_cat35.weeks_vec
left join gtrends_lab 
on full_weeks_adopt_2588.BAND_ID = gtrends_lab.bands_num_vec and full_weeks_adopt_2588.WEEK_ID = gtrends_lab.weeks_vec
--where gtrends_lab.gtrends is null
--)
;

update adopt_trends_left_join_full_weeks set trend_ori = 0 where trend_ori is null;
update adopt_trends_left_join_full_weeks set trend_cat3 = 0 where trend_cat3 is null;
update adopt_trends_left_join_full_weeks set trend_cat35 = 0 where trend_cat35 is null;
update adopt_trends_left_join_full_weeks set trend_lab = 0 where trend_lab is null;