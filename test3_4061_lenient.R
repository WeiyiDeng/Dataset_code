...
trydata <- read.csv(file="E:/Trans/Transfer from old Toshiba/SQLite/adopt_lenient_trends_left_join_full_weeks_4061.csv", header=TRUE, sep=",")
...
write.csv(file="predict_trend4061_lenient.csv", x=predict_trend, row.names = FALSE)
write.csv(file="predict_trend_log4061_lenient.csv", x=predict_trend_log, row.names = FALSE)
