--select count(*) from listen_trends_left_join_full_weeks
...
create table adopt_strict_trends_left_join_full_weeks2(adopt integer, trend_ori numeric, trend_cat3 numeric, trend_cat35 numeric, trend_lab numeric, bands_num_vec integer, weeks_vec integer);
insert into adopt_strict_trends_left_join_full_weeks2(adopt, trend_ori, trend_cat3, trend_cat35, trend_lab, bands_num_vec, weeks_vec)

--SELECT count(*)
--FROM(
select adopt, gtrends_ori.gtrends as trend_ori, gtrends_cat3.gtrends as trend_cat3, gtrends_cat35.gtrends as trend_cat35, gtrends_lab.gtrends as trend_lab, full_weeks_strict_adopt_all_users_2588.BAND_ID, full_weeks_strict_adopt_all_users_2588.WEEK_ID
from full_weeks_strict_adopt_all_users_2588
left join gtrends_ori 
on full_weeks_strict_adopt_all_users_2588.BAND_ID = gtrends_ori.bands_num_vec and full_weeks_strict_adopt_all_users_2588.WEEK_ID = gtrends_ori.weeks_vec
left join gtrends_cat3
on full_weeks_strict_adopt_all_users_2588.BAND_ID = gtrends_cat3.bands_num_vec and full_weeks_strict_adopt_all_users_2588.WEEK_ID = gtrends_cat3.weeks_vec
left join gtrends_cat35 
on full_weeks_strict_adopt_all_users_2588.BAND_ID = gtrends_cat35.bands_num_vec and full_weeks_strict_adopt_all_users_2588.WEEK_ID = gtrends_cat35.weeks_vec
left join gtrends_lab 
on full_weeks_strict_adopt_all_users_2588.BAND_ID = gtrends_lab.bands_num_vec and full_weeks_strict_adopt_all_users_2588.WEEK_ID = gtrends_lab.weeks_vec
--where gtrends_lab.gtrends is null
--)
;

update adopt_strict_trends_left_join_full_weeks2 set trend_ori = 0 where trend_ori is null;
update adopt_strict_trends_left_join_full_weeks2 set trend_cat3 = 0 where trend_cat3 is null;
update adopt_strict_trends_left_join_full_weeks2 set trend_cat35 = 0 where trend_cat35 is null;
update adopt_strict_trends_left_join_full_weeks2 set trend_lab = 0 where trend_lab is null;